...
1. Create the GitHub repository at `https://github.com/mySebbe/oss-repo-launch-doctor`.
2. Create the PyPI project named `oss-repo-launch-doctor`.
3. In PyPI, add a Trusted Publisher for:
   - Owner: `mySebbe`
   - Repository: `oss-repo-launch-doctor`
